...
|---|---|---|---|
| Saldo RCV-IMSS | 11.3 billones | 6.9 billones | **1.64** |
| Cotizantes | 27.9 M | 29.1 M | 0.96 |
| Cuentas con saldo | 63.2 M | 77.8 M | 0.81 |

Diagnóstico del 1.64: con los rendimientos ya calibrados a la serie
observada (#23, movió el ratio solo 1.6462→1.6405), el sospechoso
dominante es el supuesto 3 (salario real de 2025 constante hacia atrás);
secundarios: sin mortalidad en backcast (#4) y comisiones pre-2008 (#13).
Plan de calibración en `ASKS_JUNTA.md`.
